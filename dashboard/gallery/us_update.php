                        ...
                        <table width="100%" border="1" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td>
                                      ...
                                      <img src="../images/gallery/<?php echo $row['image'];?> ?>" alt="Current Image" style="max-width: 300px; max-height: 300px;">
                            ...
                            <tr style="height: 50px;">
                                ...
                                <td><input type="file" name="new_image" class="validate[required]" /></td>
                            </tr>
                            
                            <tr>
                                <td style="text-align: center;">Caption</td>
                                <td style="width: 90%;"><input style="width: 99%;height: 60px;" type="text" name="caption" value="<?php echo $row['caption'];?>"/></td>
                            </tr>
